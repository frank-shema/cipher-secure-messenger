...
@Component
public class TypingStartFrameHandler extends TypingFrameHandler {

    public TypingStartFrameHandler(FrameCodec codec, RelayTypingUseCase relayTyping) {
        super(codec, relayTyping, true);
    }

    @Override
    public String type() {
        return FrameType.TYPING_START;
    }
}
